            ...
            job: function() {
                ...
                if(claimlist.count() == 0){
                    ...
                    claimlist.forEach(function(value){
                        ...
                        Fiber(function(){ handlerequest(myuser_id, "aetna", value.type, value.claim_id, (value.claim_detail_href==undefined)? '' : value.claim_detail_href)}).run();
                    })
...
function loadClaimsRateNoOptions(user,provider, claimtype, claimid, data)
{
